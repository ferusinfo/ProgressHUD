...
+ (void)dismissWithCompletition:(void(^)())completionBlock {
    [[self shared] hudHideWithCompletion:completionBlock];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if (hud.superview == nil)
	{
		if (interaction == NO)
		{
            ...
            background.backgroundColor = HUD_VIEW_BACKGROUND_COLOR;
...
- (void)hudHide {
    [self hudHideWithCompletion:^{}];
}

//-------------------------------------------------------------------------------------------------------------------------------------------------
- (void)hudHideWithCompletion:(void(^)())completionBlock
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (self.alpha == 1)
	{
